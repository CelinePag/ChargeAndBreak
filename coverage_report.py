...
Usage
  python coverage_report.py                      # base case, seeds 1-50
  python coverage_report.py --seeds 10           # only the first 10 seeds
  python coverage_report.py --csv coverage.csv   # also write a CSV
  python coverage_report.py --variants           # variant/tagged runs
"""
...
def main() -> None:
    ...
    ap.add_argument("--dir", default="solutions")
