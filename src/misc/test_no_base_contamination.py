...
Usage
  python -m src.misc.test_no_base_contamination            # ~2-5 min
  python -m src.misc.test_no_base_contamination --quick    # greedy paths only (~20 s)
"""
