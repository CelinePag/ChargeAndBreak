...
Usage
-----
  python -m src.output_analysis.oracle_bound_trace instances/RlongCfewTlarge_12.json
  python -m src.output_analysis.oracle_bound_trace instances/RlongCfewTlarge_12.json --time_limit 900
  python -m src.output_analysis.oracle_bound_trace <inst> --mip_gap 0.0 --out figures/bound_trace
"""
