...
Usage
-----
  python -m src.output_analysis.oracle_stall_analysis                 # all classes
  python -m src.output_analysis.oracle_stall_analysis --class long    # one route class
"""
...
if __name__ == "__main__":
    ...
    ap.add_argument("--solutions-dir", default=_paths.solutions())
    ap.add_argument("--instances-dir", default=_paths.instances())
    args = ap.parse_args()
