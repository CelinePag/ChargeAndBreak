...
Usage
-----
  python -m src.instance_gen.norway_instance [--out instances/norway_e6.json] [--seed 1]

The output JSON has the same schema as instance_io.generate_instance_file,
so:  python -m src.simulation.runner_dispatch instances/norway_e6.json all
"""
...
def main():
    ...
    ap.add_argument("--out",  default=_paths.instances("norway_e6.json"))
