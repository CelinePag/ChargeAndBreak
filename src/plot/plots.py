...
CLI
---
    python -m src.plot.plots <run_id | instance-prefix | glob | json-path> [--show]

    Examples:
      python -m src.plot.plots RshortCfewTlarge_10_RO_20260716_092310_001
      python -m src.plot.plots RshortCfewTlarge_10            # every saved run of it
      python -m src.plot.plots "solutions/Rmedium*_LA_*.json" --show
...
def plot_simulation_results(results, full_data, title="simulation", save=True, show=False):
    ...
    from src.methods.MILP import INFEASIBLE_PENALTY
...
# ═════════════════════════════════════════════════════════════════════════════
# Replot from saved run files  (CLI: python -m src.plot.plots <run_id>)
# ═════════════════════════════════════════════════════════════════════════════
...
#
#   python -m src.plot.plots RshortCfewTlarge_10_RO_20260716_092310_001
#   python -m src.plot.plots RshortCfewTlarge_10          # all saved runs of instance
#   python -m src.plot.plots "solutions/Rmedium*_LA_*.json" --show
#
...
INSTANCES_DIR = _paths.instances()
...
def load_run(run_ref: str,
    ...
    if diesel:
        from src.simulation.runner_dispatch import _apply_diesel_mode
    ...
    N       = full_data["N"]
    from src.methods.oracle import load_oracle_cache as _load_oracle_cache
