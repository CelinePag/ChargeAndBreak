...
Usage
-----
  python resync_oracle.py                 # dry run: report what WOULD change
  python resync_oracle.py --apply         # actually rewrite the method files
  python resync_oracle.py --apply --instance RlongCfewTlarge_12
  python resync_oracle.py --apply --route long      # only long-route instances
"""
...
if __name__ == "__main__":
    ...
    p.add_argument("--dir", default="solutions",
