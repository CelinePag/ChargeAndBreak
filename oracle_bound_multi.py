...
Usage
-----
  python oracle_bound_multi.py                       # all classes present
  python oracle_bound_multi.py --glob "logs/oracle_trace_Rlong*.log"
  python oracle_bound_multi.py --out-dir figures
"""
