...
\input{tex/tables/additional_la}
...
\begin{figure}[htbp]
    ...
    share $\sum_i g_i/\sum_i \tau^c_i$.  Every bar averages the 100 instances of
    its route class (2 customer counts $\times$ 2 window classes $\times$ 25
    seeds).}
    \label{fig:diesel}
\end{figure}
