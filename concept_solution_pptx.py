...
Run:  python concept_solution_pptx.py
"""
import json
import math
import os
...
OUT  = os.path.join(BASE, "figures", f"solution_concept_{SOL}.pptx")

# ================================================================ data ======
sol  = json.load(open(os.path.join(BASE, "solutions", SOLFILE + ".json")))
inst = json.load(open(os.path.join(BASE, "instances", INST + ".json")))
fd     = inst["instance"]
D_real = inst["D_real"]
E_real = inst["E_real"]
