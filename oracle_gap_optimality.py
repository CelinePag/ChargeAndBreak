...
Usage
-----
  python oracle_gap_optimality.py
  python oracle_gap_optimality.py --glob "logs/oracle_RmediumC*_gurobi.log"
  python oracle_gap_optimality.py --xmax 300 --ymin -25 --ymax 50
"""
...
if __name__ == "__main__":
    ...
    ap.add_argument("--glob", default="logs/oracle_RmediumC*_gurobi.log",
                    help="glob of oracle Gurobi logs (default: medium)")
    ap.add_argument("--out", default="figures/oracle_gap_optimality",
