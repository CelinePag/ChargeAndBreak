...
Launched per instance by ``python additional_analysis.py vss``; can also be
run standalone:
...
# repo root importable when run as experiments/vss_evpi.py
sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

from instance_io import load_instance_json                     # noqa: E402
from oracle      import oracle_solve                           # noqa: E402
from recourse    import run_plan_with_recourse                 # noqa: E402
from scenarios   import generate_scenarios                     # noqa: E402
